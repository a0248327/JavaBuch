...
public class Pagination {
	...
	public static String getPagination(int pageNum, int pageCount, int recordCount, String pageUrl) {
		...
		buffer.append("	var numText = document.getElementsByName('helloweenvsfei_goto_input')[0].value;");
		...
		buffer.append("}");
		buffer.append("document.getElementsByName('helloweenvsfei_goto_input')[0].onkeypress = helloweenvsfei_enter;");
		buffer.append("document.getElementsByName('helloweenvsfei_goto_button')[0].onclick = helloweenvsfei_goto;");
