...
<div id="main">
	...
	<div class="t" style="margin-bottom: 0px; border-bottom: 0">
		<table cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<th class="h"><strong class="fl w"><b>本页主题:</b> ${ thread.title }</strong>
				</th>
			</tr>
			<tr>
				<td></td>
	...
	<c:if test="${ pagination.pageNum == 1 }">
		<div class="t t2">
			<table cellspacing="0" cellpadding="0" width="100%"
				...
				<tr class="tr1">
					<th style="width: 20%" rowspan="2" class="r_two"><b>作者：${ thread.author.account }</b>
						<div class="user-pic">
							<table style="border: 0">
								<tr>
									<td width="1"><a
										href="profile-htm-action-show-uid-281652.html" target="_blank"
				...
				<tr class="tr1 r_one">
					<th style="vertical-align: bottom; padding-left: 15px; border: 0">
						...
						<div class="tipad">
							...
							</span> <span class="gray">Posted: ${ thread.dateCreated } |</span> <span><a
								class="s3">原帖</a> </span>
						</div>
					</th>
				</tr>
	...
	<c:forEach var="reply" items="${ replyList }">
		<div class="t t2">
			<table cellspacing="0" cellpadding="0" width="100%"
				style="table-layout: fixed; border-top: 0">
				<tr class="tr1">
					<th style="width: 20%" rowspan="2" class="r_two"><b>作者：${ reply.author.account }</b>
						<div class="user-pic">
							<table style="border: 0">
								<tr>
									<td width="1"><a
				...
				<tr class="tr1 r_one">
					<th style="vertical-align: bottom; padding-left: 15px; border: 0">
						...
						<div class="tipad">
							<span style="float: right"> <a
								href="javascript:scroll(0,0)" title="顶端">顶端</a>
							</span> <span class="gray">Posted: ${ reply.dateCreated }|</span> <span><a
								class="s3">${ reply.floor } 楼</a> </span>
						</div>
					</th>
				</tr>
			</table>
