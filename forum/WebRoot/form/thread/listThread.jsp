			...
			<tr>
				...
				<td style="text-align: right"><a
					href="<html:rewrite action="/thread?action=initAdd" />&board.id=${ board.id }"><img
						src="images/yellow/post.png" id="td_post" /> </a></td>
			</tr>
		</table>
	</div>
				...
				<c:forEach var="thread" items="${ threadList }">
					...
					<tr align="center" class="tr3 t_one">
						...
						<td class="tal y-style"><a
							...
							<div class="f10">${ thread.dateCreated }</div></td>
						...
						<td class="tal y-style">&nbsp; <c:if
								...
								<div class="f10">${ thread.dateLastReplied }</div>
							</c:if>
						</td>
					</tr>
				</c:forEach>
	...
	<div class="t3">
		<table cellspacing="0" cellpadding="0" width="100%" align="center">
			<tr valign="top">
				...
				<td style="text-align: right; padding-top: 5px"><a
					href="<html:rewrite action="/thread?action=initAdd" />&board.id=${ board.id }"><img
						src="images/yellow/post.png" id="td_post" /> </a></td>
			</tr>
		</table>
