...
<div id="main">
	...
	<div class="t" style="margin-bottom: 0px; border-bottom: 0">
		<table cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<th class="h"><strong class="fl w">设置版主</strong> &nbsp; <span
	...
	<html:form action="/board">
		...
		<div class="t t2">
			<table cellspacing="0" cellpadding="0" width="100%"
				...
				<tr class="tr3">
					<td style="width: 120px;">版面名称:</td>
					<td>${ board.name } &nbsp;</td>
				</tr>
				<tr class="tr3">
					<td style="width: 120px;">版面描述:</td>
					<td>${ board.description } &nbsp;</td>
				</tr>
				<tr class="tr3">
					<td style="width: 120px;">版主:</td>
					<td><c:forEach items="${ personList }" var="person">
							<html:multibox property="adminId" value="${ person.id }" />${ person.account }
						</c:forEach></td>
				</tr>

				<tr class="tr3">
					<td colspan="2"><html:submit styleClass="btn" value="保存" /></td>
				</tr>
